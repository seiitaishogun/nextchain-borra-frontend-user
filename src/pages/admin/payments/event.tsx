...
import { fetchExcelDownload, fetchPaymentsEvent } from '@/api/admin/payments';
...
function PaymentsEvent() {
  ...
  const { data, isLoading } = useQuery(
    ['adminPaymentsEvent', { page, ...searchFilters }],
    () => fetchPaymentsEvent({ page: Number(page), ...searchFilters })
  );
  const {
    list,
...
export default PaymentsEvent;

PaymentsEvent.getLayout = function getLayout(page: ReactElement) {
