...
import { fetchExcelDownload, fetchPaymentsApp } from '@/api/admin/payments';
...
function PaymentsApp() {
  ...
  const { data, isLoading } = useQuery(
    ['adminPaymentsApp', { page, ...searchFilters }],
    () => fetchPaymentsApp({ page: Number(page), ...searchFilters })
  );
  const {
    list,
...
PaymentsApp.getLayout = function getLayout(page: ReactElement) {
